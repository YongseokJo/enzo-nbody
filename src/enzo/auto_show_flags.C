...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"\n");
   fprintf (fp,"INCLUDES = -I/mnt/sw/nix/store/y21dfwf4vgh0nyqpwk1brp3xz87sxpq6-hdf5-1.8.22//include  -I/mnt/sw/nix/store/5gzzqpkmbz1rjmlwxa3f9mvmzalkzqlk-intel-oneapi-mpi-2021.9.0/include       -I/mnt/home/yjo10/packages/grackle/build/include    -I.\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/mnt/sw/nix/store/y21dfwf4vgh0nyqpwk1brp3xz87sxpq6-hdf5-1.8.22//lib -lhdf5 -lz  -lgfortran   -L/mnt/sw/nix/store/5gzzqpkmbz1rjmlwxa3f9mvmzalkzqlk-intel-oneapi-mpi-2021.9.0/lib -lmpi        -L/mnt/sw/nix/store/bdhdh478f6slibd9zpgmgw8grnqq78im-cuda-11.4.4//lib64 -lcudart -L/mnt/home/yjo10/packages/grackle/build/lib -lgrackle\n");
   fprintf (fp,"\n");
}

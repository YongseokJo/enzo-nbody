...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"\n");
   fprintf (fp,"INCLUDES = -I/mnt/sw/nix/store/wq2k7di4wq3m1ipyhqr5vidxii0zrn6i-hdf5-1.8.22/include  -I/mnt/sw/nix/store/l19ja561rfvfgv3y387gddf7fgxs8gcw-intel-oneapi-mpi-2021.8.0/include       -I/mnt/home/yjo10/packages/grackle/build/include    -I.\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/mnt/sw/nix/store/wq2k7di4wq3m1ipyhqr5vidxii0zrn6i-hdf5-1.8.22/lib -lhdf5 -lz  -lgfortran   -L/mnt/sw/nix/store/l19ja561rfvfgv3y387gddf7fgxs8gcw-intel-oneapi-mpi-2021.8.0/lib -lmpi        -L/mnt/sw/nix/store/3xpm36w2kcri3j1m5j15hg025my1p4kx-cuda-11.8.0/lib64 -lcudart -L/mnt/home/yjo10/packages/grackle/build/lib -lgrackle\n");
   fprintf (fp,"\n");
}

...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/home/sykim/local/hdf5-1.12.1//lib -lhdf5  -lgfortran  -L/home/sykim/local/openmpi-4.1.3/lib -lmpi        -L/usr/local/cuda-11.8/lib64 -L/home/sykim/local/grackle/lib -lgrackle\n");
   fprintf (fp,"\n");

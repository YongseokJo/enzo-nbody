...
void auto_show_flags(FILE *fp) {
   fprintf (fp,"make[1]: Warning: File `DEPEND' has modification time 103 s in the future\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/home/kerex/packages/hdf5-1.8.20/build/lib -lhdf5 -lz  -lgfortran   -L/appl/intel/oneapi/mpi/2021.4.0/lib -lmpi        -L/usr/local/cuda-11.8/lib64 -lcudart -L/home/kerex/packages/grackle/build/lib -lgrackle\n");
   fprintf (fp,"\n");

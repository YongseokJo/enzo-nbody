...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"CC  = /mnt/sw/nix/store/ffaf03r8cgs6sps4lai73353z5kcmjyw-openmpi-1.10.7/bin/mpicc\n");
   fprintf (fp,"CXX = /mnt/sw/nix/store/ffaf03r8cgs6sps4lai73353z5kcmjyw-openmpi-1.10.7/bin/mpicxx\n");
   fprintf (fp,"FC  = /mnt/sw/nix/store/ffaf03r8cgs6sps4lai73353z5kcmjyw-openmpi-1.10.7/bin/mpif77\n");
   fprintf (fp,"F90 = /mnt/sw/nix/store/ffaf03r8cgs6sps4lai73353z5kcmjyw-openmpi-1.10.7/bin/mpif90\n");
   fprintf (fp,"LD  = /mnt/sw/nix/store/ffaf03r8cgs6sps4lai73353z5kcmjyw-openmpi-1.10.7/bin/mpicxx\n");
   fprintf (fp,"\n");

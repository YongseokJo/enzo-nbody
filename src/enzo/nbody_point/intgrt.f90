...
*       Search only in prepared list of short-step particles. (R.Sp.)
         ...
         DO L = 2,ISHORT+1
            I = LSHORT(L)
            write(6,*) "the ",L,"th member of LSHORT is",I
...
c$$$  END IF
     ...
     &           I.GE.IFIRST) THEN
      ...
      END IF
*
      write(6,*) 'ISMIN = ',ISMIN,'STEP(ISMIN) = ',DSMIN
      write(6,*) 'neighbor number of ISMIN = ',LIST(1,ISMIN)
      write(6,*) 'first neighbor of ISMIN = ',LIST(2,ISMIN)
      call flush(6)

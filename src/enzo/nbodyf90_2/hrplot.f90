...
!      if(rank.eq.0) WRITE (83,1)  NS, TPHYS
    ...
    !       Obtain stellar parameters at current epoch.
        ...
        !       Create output file for single stars (skip chain subsystem or ghost).
            IF (NAME(I) == 0 .OR. BODY(I) == 0.0D0) GO TO 20

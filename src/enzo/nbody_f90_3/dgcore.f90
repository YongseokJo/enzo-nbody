...
! The envelope will not survive if its binding energy is reduced to <= 0.
    if(de >= 0.d0) ebinde = MAX(0.d0,ebinde - enuc)
! Now determine the final evolution state of the merged core.
    if(de < 0.d0) kw3 = 15
    if(kw3 == 3)then
        if(x > 0.5d0)then
            kw3 = 6
        elseif(ebinde <= 0.d0)then
            kw3 = 10
        endif
    elseif(kw3 == 4)then
        if(x > 0.5d0)then
    ...
    if(kw3 == 6 .AND. y < 0.5d0)then
        if(ebinde <= 0.d0) kw3 = 11
    elseif(kw3 == 6 .AND. y > 0.5d0)then
        if(ebinde <= 0.d0) kw3 = 12
    endif
    if(kw3 == 10 .AND. x > 0.5d0) kw3 = 11
    if(kw3 == 11 .AND. y > 0.5d0) kw3 = 12
    if(kw3 >= 10 .AND. kw3 <= 12 .AND. m3 >= mch) kw3 = 15

    if(kw3 == 15) m3 = 0.d0
    90 continue

    return
    end SUBROUTINE dgcore
!**

...
!       Check hierarchical stability condition for bound close pair.
    ...
    IF (PMIN > PCRIT .AND. AIN > 0.0 .AND. SEMI1 > 0.0 .AND. &
    RB > SEMI) THEN
        ITERM = -1

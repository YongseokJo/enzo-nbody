...
! This way, you can easily sum up multiple components!
    ...
    IF(IKEYPOT(1) == 1) CALL pointmass(ttphig,x,y,z,t,msc,rsc,tsc,vsc)
    IF(IKEYPOT(2) == 1) CALL plummer(ttphig,x,y,z,t,msc,rsc,tsc,vsc)
    IF(IKEYPOT(3) == 1) CALL hernquist(ttphig,x,y,z,t,msc,rsc,tsc,vsc)
    IF(IKEYPOT(4) == 1) CALL nfw(ttphig,x,y,z,t,msc,rsc,tsc,vsc)
    IF(IKEYPOT(5) == 1) CALL nfw2(ttphig,x,y,z,t,msc,rsc,tsc,vsc)
    IF(IKEYPOT(6) == 1) CALL isothermal(ttphig,x,y,z,t,msc, &
    rsc,tsc,vsc)
    IF(IKEYPOT(7) == 1) CALL nakedmndisk(ttphig,x,y,z,t,msc, &
    rsc,tsc,vsc)
    IF(IKEYPOT(8) == 1) CALL pseudoexpdisk(ttphig,x,y,z,t,msc, &
    rsc,tsc,vsc)
    IF(IKEYPOT(9) == 1) CALL bulgediskhalo(ttphig,x,y,z,t,msc, &
    rsc,tsc,vsc)
    IF(IKEYPOT(10) == 1) CALL spiralarms(ttphig,x,y,z,t,msc, &
    rsc,tsc,vsc)
    IF(IKEYPOT(11) == 1) CALL nfwcosmo(ttphig,x,y,z,t,msc,rsc,tsc,vsc)

...
! he function is singular for m1=0, but the following holds:
! or 0 < m1 <=1 (m1 never > 1),  \infty > PFAC(m1) > 1.6, with P(0.01)=3.6.
! o taking it as 1 isn't too bad for an order of magnitude estimate.

...
!       Loop over all particles split into NIMAX blocks.
    ...
    !**** Note:------------------------------------------------------------**
    !$$$          print*,rank,'IOFF',IOFF,'NI',NI,'IS',ISTART,'IE',IEND,
    !$$$     &         'IREG',IREG(IOFF:IOFF+2),'JNEXT',JNEXT
    ...
    !     Check for zero neighbor
        ...
        !     --11/30/14 16:46-lwang-debug--------------------------------------*
        !**** Note:------------------------------------------------------------**
        !$$$             print*,rank,'IOFF',IOFF,'NINEW',NINEW,
        !$$$     &            'IREG',IREG(IOFF:2+IOFF)
        !     --11/30/14 16:46-lwang-end----------------------------------------*
...
!       end added by sykim
    ...
    !$$$      print*, 'rank ',rank,' istsen ',istsen,' istrec-1 ',istrec-1,
    !$$$     &     ' before fi(1) ',fi(1,istsen), ' fi(e) ',fi(1,istrec-1),
    !$$$     &     ' size',icnt,' isend',isend,' irecv',irecv
    ...
    !$$$      print*, 'rank ',rank,' istsen ',istsen,' istrec ',istrec,
    !$$$     &     ' after fi(1) ',fi(1,istsen), ' fi(e) ',fi(1,istrec)
        #endif

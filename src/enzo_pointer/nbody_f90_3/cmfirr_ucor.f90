...
!       Perform differential correction for regularized c.m. neighbours.
    ...
    !$$$         write(110+rank,*),'J',J,'N',name(J),'X',X(1,J),'X1',X(1,J1),
    !$$$     &        'X2',X(1,J2),'XD',XDOT(1,j),'XD1',XDOT(1,j1),
    !$$$     &        'XD2',XDOT(1,j2),'X0',X0(1,J),'X0D',X0DOT(1,J),
    !$$$     *        'F',F(1,J),'FDOT',FDOT(1,J),'TPR',TPRED(J),'T',TIME
    !$$$         call flush(110+rank)
    !$$$      end if
